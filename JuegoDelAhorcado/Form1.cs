...
namespace JuegoDelAhorcado
{
    public partial class Form1 : Form
    {
        ...
        public void IniciarJuego(string palabra)
        {
            ...
            IniciarlizarPalabra();
            MessageBox.Show("solo cuenta con 7 intentos. Dele Aceptar para continuar con el juego");
        ...
        private void Win()
        {
            MessageBox.Show($"Felicitaciones adivinaste la palabra clave, ya eres libre");
            MessageBox.Show($"Selecione una categoria para volver a jugar");
